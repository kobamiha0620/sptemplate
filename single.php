  ...
  <article <?php post_class( 'article-content' ); ?>>
      ...
      <div class="single__contents">
        ...
        <div class="single__contentsinner">
          ...
          <div class="epicShop">
            ...
            <?php if(get_field('epick_insta')): ?>
    <!-- //インスタ -->
    <div class="epicShop__insta">
    <blockquote class="instagram-media" data-instgrm-captioned
      data-instgrm-permalink="<?php the_field('epick_insta'); ?>?utm_source=ig_embed&amp;utm_campaign=loading"
      data-instgrm-version="14"
      style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
      <div style="padding:16px;">
        <a href="<?php the_field('epick_insta'); ?>?utm_source=ig_embed&amp;utm_campaign=loading"
        ...
        <p
          ...
          <a href="<?php the_field('epick_insta'); ?>?utm_source=ig_embed&amp;utm_campaign=loading"
            ...
            target="_blank">Gaia Sea Moss(@gaiaseamoss_)がシェアした投稿</a></p>
      </div>
    </blockquote>
    ...
    <?php endif; ?>
              ...
              <div class="epicShop__blc">
                <div class="epicShop__name">
                  <div class="epicShop__name--item">ITEM</div>
                  <div clas="epicShop__name--ttl"><?php the_field('product_name'); ?> </div>
                </div>
